    ...
    <div className="homepage">
        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            ...
            <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
              Expedita adipisci ad, deserunt voluptas deleniti nisi.</p>
              <button className="btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-
              ...
              animate__animated animate__fadeInUp animate__delay-1s"> Lihat Promo</button>
            </Col>
        ...
        <Container>
          <Row>
            ...
            <p className="text-center">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi, magnam.</p>
            </Col>
          </Row>
          <Row>
            {kelasTerbaru.map((kelas)=>{
              return (<Col key={kelas.id} className="shadow rounded" data-aos="fade-up" 
          ...
          <Row>
            ...
            data-aos="fade-up" data-aos-duration="1000">Lihat Semua Kelas
