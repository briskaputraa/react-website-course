...
const FooterComponents = () =>{
    ...
    <div className='footer py-5'>
        <Container>
            <Row className='d-flex justify-content-between'>
                <Col lg="5">
                    ...
                    <p className='desc'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                        Neque, expedita quia enim dolorum debitis aliquam recusandae
                        id eos veniam quibusdam.
                    </p>
            ...
            <Row>
                <Col>
                <p className='text-center px-md-0 px-3'>&copy; Copyright {new Date().getFullYear()} by <span className='fw-bold'>Briska Ananda</span> ,All Right Reversed</p>
                </Col>
            </Row>
        </Container>
    </div>
